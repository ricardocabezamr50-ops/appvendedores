...
const FILTER_VALUE: string | null = 'precios';
...
export default function PreciosScreen() {
  ...
  if (level === null || loading) return (<View style={S.center}><ActivityIndicator /><Text style={S.muted}>Cargando listas de precios…</Text></View>);
